...
class Monster extends AbstractFile implements Comparable<Monster>
{
	...
	public Monster (String name, byte[] buffer, List<Reward> rewards, List<Monster> monsters)
	{
		super (name, buffer);
	...
	public String getText ()
	{
		...
		int exp2 = (HexFormatter.intValue (buffer[72]) * HexFormatter.intValue (buffer[74]) - 1) * 20;
